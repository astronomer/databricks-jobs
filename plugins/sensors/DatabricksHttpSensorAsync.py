...
class DatabricksHttpSensorAsync(HttpSensor):
    """
    ...
    :param initial_delay: Time to delay before first API call
    :type: int
    """
    template_fields: Sequence[str] = ('endpoint', 'request_params', 'headers', 'initial_delay')

    def __init__(self,
                 initial_delay: Optional[int] = None,
                 *args,
                 **kwargs):
        super(DatabricksHttpSensorAsync, self).__init__(*args, **kwargs)
        self.initial_delay = initial_delay
        # self.get_operator_extra_link(self.run_page_url)
